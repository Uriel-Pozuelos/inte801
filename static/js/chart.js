...
!(function (t, e) {
	...
	function te(t) {
		return Jt(t)
			? t
			: new Zt(t).saturate(0.5).darken(0.1).hexString();
	}
	...
	function ne(t, e, i) {
		return (function (t, e) {
			...
			let s = se.get(i);
			return (
				s || ((s = new Intl.NumberFormat(t, e)), se.set(i, s)), s
			);
		})(e, i).format(t);
	}
	const oe = {
		...
		logarithmic(t, e, i) {
			if (0 === t) return '0';
			const s =
				i[e].significand || t / Math.pow(10, Math.floor(z(t)));
	...
	function Gi(t, e) {
		return t.filter(
			t => -1 === qi.indexOf(t.pos) && t.box.axis === e
		);
	}
	function Zi(t, e) {
		return t.sort((t, i) => {
	...
	class Ns {
		...
		updateRangeFromParsed(t, e, i, s) {
			...
			s &&
				a &&
				((s.values = a), (o = Ls(s, n, this._cachedMeta.index))),
		...
		getMinMax(t, e) {
			...
			for (
				u = 0;
				u < o &&
				(g() || (this.updateRangeFromParsed(h, t, f, l), !n));
				++u
			);
			if (n)
				for (u = o - 1; u >= 0; --u)
	...
	function ho(t, e, i, s) {
		...
		return (
			a &&
			(n || tt(e, a.left, a.right)) &&
			(o || tt(i, a.top, a.bottom))
		);
	}
	function co(t, e) {
	...
	class bo extends Js {
		...
		getTickLimit() {
			...
			return (
				s
					? ((e =
							Math.ceil(this.max / s) - Math.floor(this.min / s) + 1),
					  e > 1e3 &&
							(console.warn(
	...
	class ko extends Js {
		...
		handleTickRangeOptions() {
			...
			const n = e => (i = t ? i : e),
				o = t => (s = e ? s : t);
			i === s &&
				(i <= 0 ? (n(1), o(10)) : (n(yo(i, -1)), o(yo(s, 1)))),
				i <= 0 && n(yo(s, -1)),
				s <= 0 && o(yo(i, 1)),
				(this.min = i),
				(this.max = s);
	...
	var jo = Object.freeze({
		...
		CategoryScale: class extends Js {
			...
			parse(t, e) {
				...
				return ((t, e) =>
					null === t ? null : J(Math.round(t), 0, e))(
					(e =
						isFinite(e) && i[e] === t
							? e
	...
	class xa extends Hs {
		...
		_getLegendItemAt(t, e) {
			let i, s, n;
			if (
				tt(t, this.left, this.right) &&
				tt(e, this.top, this.bottom)
			)
	...
	function Pa(t, e) {
		return (
			e && (n(e) ? Array.prototype.push.apply(t, e) : t.push(e)), t
		);
	}
	function Da(t) {

...
ALTER TABLE relacionGalletaMateria DROP FOREIGN KEY relacionGalletaMateria_ibfk_2;


ALTER TABLE relacionGalletaMateria DROP FOREIGN KEY relacionGalletaMateria_ibfk_1;

ALTER TABLE merma_materia DROP FOREIGN KEY merma_materia_ibfk_1;
